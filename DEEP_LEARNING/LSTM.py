...
def fit_model(xtrain, ytrain, xval, yval, individual_fixed_part, individual_variable_part, prediction_horizon, scaler, epochs=10, batch=1024, model='lstm'):
    ...
    if 'lstm' in model:
        ...
        return fit_enc_dec_att_model(xtrain, ytrain, xval, yval, individual_fixed_part, individual_variable_part,
                              prediction_horizon, scaler, epochs, batch)
